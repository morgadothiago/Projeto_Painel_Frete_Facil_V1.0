    ...
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: "inherit" }}>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.95)", fontWeight: 700, fontSize: 16 }}>{name}</span>
        </div>
        ...
        <div style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.72)", lineHeight: 1.7, margin: 0, maxWidth: 280 }}>
            Escolha uma senha forte com pelo menos 6 caracteres para proteger sua conta.
          </p>
        </div>
      </div>
